...
Making Spatial Rasters for environment data
```{r}
...
train_indices <- sample(1:nrow(cq), size = 0.8 *nrow(cq)) #taking a random sample from cq
train_data <- cq[train_indices,]
test_data <- cq[-train_indices,]
nrow(train_data) 
nrow(test_data) 
